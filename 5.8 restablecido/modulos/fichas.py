# -*- coding: utf-8 -*-
"""
Módulo de consola - Fichas Técnicas Host AI
Sprint 5.9 - Hotfix limpio de MODULOS/fichas.py

Este archivo sustituye únicamente:
C:\Proyectos\Host-AI\MODULOS\fichas.py

Mantiene:
- Buscar ficha por nombre o código interno.
- Si hay varias coincidencias, elegir una.
- Ver ficha como cocinero.
- Crear borrador desde receta.
- Completar ficha existente.
- Editar ficha con lenguaje natural.
- Duplicar ficha.
- Validar ficha.
- Historial.
- Buscar fichas.
...
def _crear_demo_carrillera() -> None:
    ...
    print("\nCódigo interno: ELAB-CAR-001")
    print("Nombre buscable: carrillera")
